...
//   };
  ...
  // this.setTypeView = function(tv) {
  //   typeView = tv;
  // };

  // this.displayFilteredEvents = function(filteredEvents, startTime, endTime) {
  //   console.log("displayFilteredEvents called with:", filteredEvents.length, "events");
  //   console.log("Start time:", startTime.toLocaleString(), "End time:", endTime.toLocaleString());

  //   list.selectAll("*").remove(); // Clear existing list

  //   if (filteredEvents.length === 0) {
  //     console.log("No events to display");
  //     list.append("p").text("No events in the selected range.");
  //   } else {
  //     const eventList = list.append("ul").style({
  //       "font-size": "10px",
  //       "font-family": "monospace",
  //       "white-space": "nowrap"
  //     });
  ...
  //       console.log("Displaying event:", event.id, "Time:", eventTime.toLocaleString());
  //       if (eventTime >= startTime && eventTime <= endTime) {
  //         eventList.append("li").text(
  //           eventTime.toLocaleDateString() + ": " + event.id + " (" + event.group + ")"
  //         );
  //       } else {
  //         console.log("Event outside range:", event.id, eventTime.toLocaleString());
  //       }
  //     });
  //   }
    // if (typeView) {
    //   typeView.updateBasedOnFilteredEvents(filteredEvents); // Notify TypeView
    // }
  // };
